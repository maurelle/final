       ...
       <form method="get">
         <div class="row">
          <div class="col-10">
           ...
           <div class="col-2">
             <button class="btn btn-primary btn-block" type="submit">  ส่ง </button>
            </div>
            </div>
            </form>
            </div>
              ...
              <img class="card-img-top" src="<?php echo $music['album']['images'][0]['url'] ?>" alt="">
               <div class="card-body">
                 <h5> <?php echo $music['name'] ?></h5>
                  <p> Artist : <?php echo $music['artists'][0]['name'] ?> </p>
                  <p> Release date : <?php echo $music['album']['release_date'] ?> </p>
                  <p> Available : <?php echo count($music['available_markets']) ?> countries </p>
                </div>
               </div>
              </div>
            <?php
